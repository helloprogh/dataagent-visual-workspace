...
- For same-stack cross-project replication, use `npm run export:frontend-kit`; `export:style-pack` is only a compatibility alias. Do not hand-maintain a second copy of the canonical styles in this repository.
