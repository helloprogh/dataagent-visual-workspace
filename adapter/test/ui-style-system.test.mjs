...
test('conversation presentation is Element-Plus-X over direct AG-UI client', async () => {
  ...
  assert.match(processGroup, /<details class="process-group"[^>]*:open="Boolean\(running\)"/)
  ...
  assert.match(processGroup, /\.process-group\[open\] > \.process-group__header \.process-group__chevron/)
