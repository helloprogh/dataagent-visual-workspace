...
export const demoWorkspace: Workspace = {
  title: '经营智能分析工作区',
  summary: '本月核心指标保持增长，直播渠道与新客贡献突出。退款率有轻微抬升，建议继续观察。',
  kpis: [
  ...
  widgets: [
    { id: 'trend', type: 'trend', title: 'GMV 趋势', points: [42, 48, 45, 56, 61, 58, 72, 68, 79, 84, 91, 96] },
    { id: 'insights', type: 'insights', title: '关键洞察', items: ['直播渠道贡献 6.8 个百分点', '新客转化率提升 3.1%', '华东区域连续三周增长', '退款率较上月升高 0.8%'] },
  ],
  agents: [
  ...
  activities: [
    { id: 'a1', agentId: 'sql', message: '查询完成，返回 1,284 行数据', status: 'completed', timestamp: '16:08:22' },
    { id: 'a2', agentId: 'quality', message: '质量检查完成，发现 2 个提示项', status: 'completed', timestamp: '16:08:23' },
    { id: 'a3', agentId: 'insight', message: '正在执行渠道与人群归因', status: 'running', timestamp: '16:08:25' },
  ],
}
