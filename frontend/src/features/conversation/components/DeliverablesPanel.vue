...
.deliverable-item { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: var(--da-space-3); width: 100%; padding: var(--da-space-3); border: 0.0625rem solid var(--da-border); border-radius: var(--da-radius-md); color: var(--da-text-muted); background: var(--da-surface-2); text-align: left; transition: border-color 160ms ease, background-color 160ms ease, transform 160ms ease; }
...
.deliverable-item > button { display: grid; min-width: 0; gap: 0.125rem; padding: 0; border: 0; color: inherit; background: transparent; cursor: pointer; text-align: left; }
...
.deliverable-item__actions { display: flex; align-items: center; gap: var(--da-space-1); }
.deliverable-item__actions em { padding: 0.125rem 0.3125rem; border-radius: 999rem; color: var(--da-brand-cyan); background: var(--da-surface-3); font-size: 0.625rem; font-style: normal; }
.deliverable-item__actions a { display: grid; width: 1.75rem; height: 1.75rem; place-items: center; border-radius: var(--da-radius-sm); color: var(--da-text-muted); text-decoration: none; }
.deliverable-item__actions a:hover { color: var(--da-text-emphasis); background: var(--da-surface-hover); }
